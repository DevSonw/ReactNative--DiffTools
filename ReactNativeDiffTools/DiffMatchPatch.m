...
- (id)initWithCoder:(NSCoder *)aDecoder{
    _operation = [aDecoder decodeIntegerForKey:@"operation"];
...
- (void)encodeWithCoder:(NSCoder *)aCoder{
    [aCoder encodeObject:_diffs forKey:@"diffs"];
    [aCoder encodeInteger:_start1 forKey:@"start1"];
    [aCoder encodeInteger:_start2 forKey:@"start2"];
    [aCoder encodeInteger:_length1 forKey:@"length1"];
    [aCoder encodeInteger:_length2 forKey:@"length2"];
}
- (id)initWithCoder:(NSCoder *)aDecoder{
    _diffs = [aDecoder decodeObjectForKey:@"diffs"];
    _start1 = [aDecoder decodeIntegerForKey:@"start1"];
    _start2 = [aDecoder decodeIntegerForKey:@"start2"];
    _length1 = [aDecoder decodeIntegerForKey:@"length1"];
    _length2 = [aDecoder decodeIntegerForKey:@"length2"];
    return self;
}
